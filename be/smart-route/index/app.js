...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_api_smart_route_rule_js__ = __webpack_require__(970);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_api_smart_route_rule_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_components_api_smart_route_rule_js__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setRule: function () {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_0_components_api_smart_route_rule_js___default.a.set(_this.form).then(function (resp) {
                _this.$notify.success("保存成功！");
            });
        },
        getRule: function () {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_0_components_api_smart_route_rule_js___default.a.get().then(function (resp) {
                _this.form = resp.data;
            });
        },
        getip: function () {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_0_components_api_smart_route_rule_js___default.a.getip().then(function (resp) {
                _this.ip = resp.data;
            });
        }
    },
...
var base = '/smart-route';

var rule = {
	get: function get() {
		return _axios2.default.post(base + '/rule/get');
	},
	set: function set(data) {
		return _axios2.default.post(base + '/rule/set', data);
	},
	getip: function getip() {
		return _axios2.default.post(base + '/rule/getip');
	}
};
...
var _app = __webpack_require__(890);
...
var update = __webpack_require__(187)("4a432dd2", content, true);
