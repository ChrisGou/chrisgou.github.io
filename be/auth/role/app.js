...
$export($export.P + $export.F * (__webpack_require__(63) != Object || !__webpack_require__(25)(arrayJoin)), 'Array', {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(15)(proto, TO_PRIMITIVE, __webpack_require__(194));
...
var base = '/oauth2-service/menuurl';

var api = {
  selectbyid: function selectbyid(id) {
    return _axios2.default.get(base + '/selectbyid?id=' + id);
  },
  add: function add(params) {
    return _axios2.default.post(base + '/add', params);
  },
  update: function update(params) {
    return _axios2.default.post(base + '/update', params);
  },
  listByIds: function listByIds(params) {
    return _axios2.default.post(base + '/listbyids', params);
  },
  getbymenuid: function getbymenuid(menuId) {
    return _axios2.default.get(base + '/getbymenuid?menuId=' + menuId);
  },
  listbymenuids: function listbymenuids(ids) {
    return _axios2.default.post(base + '/listbymenuids', ids);
  }
};
exports.default = api;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_api_role_js__ = __webpack_require__(833);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_api_role_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_components_api_role_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_api_roleuser_js__ = __webpack_require__(834);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_api_roleuser_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_components_api_roleuser_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_api_auth_rolemenu_js__ = __webpack_require__(959);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_api_auth_rolemenu_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_components_api_auth_rolemenu_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_components_api_auth_roleurl_js__ = __webpack_require__(832);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_components_api_auth_roleurl_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_components_api_auth_roleurl_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_components_api_menu__ = __webpack_require__(808);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_components_api_menu___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_components_api_menu__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_components_api_auth_apicatalog__ = __webpack_require__(523);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_components_api_auth_apicatalog___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_components_api_auth_apicatalog__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_components_api_auth_apidoc__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_components_api_auth_apidoc___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_components_api_auth_apidoc__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_components_api_auth_menuurl__ = __webpack_require__(831);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_components_api_auth_menuurl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_components_api_auth_menuurl__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        authButtonVisible(roleId) {
            var roles = this.roles;
            for (var i = 0; i < roles.length; i++) {
                if (roleId == roles[i].roleId) {
                    if (roles[i].status == "1") return true;
                }
            }
        },
        startMenuAuthorize() {
            this.menuSetCheckedKeys = false;
        },
        stopMenuAuthorize() {
            this.menuSetCheckedKeys = true;
        },
        startUrlAuthorize() {
        ...
        menuCheckChange(item, checked) {
            var _this = this;
            var menuUrlList = _this.menuUrlMap[item.id];
            // console.info(_this.menuUrlList);
            if (checked) {
                __WEBPACK_IMPORTED_MODULE_9_underscore___default.a.each(menuUrlList, function (u) {
                    _this.addRoleUrl({
                        url: u.url,
                        urlId: u.id
                    });
                ...
                __WEBPACK_IMPORTED_MODULE_9_underscore___default.a.each(menuUrlList, function (u) {
                    _this.removeRoleUrl(u.url);
                });
            }
            // console.info(_this.roleUrls);
        },
        saveAuth() {
            var _this = this;
            ...
            console.log(menuIds);
            var urls = this.roleUrls;
            __WEBPACK_IMPORTED_MODULE_1_components_api_role_js___default.a.resetAuth({
                menuIds: menuIds,
                urls: urls,
                roleId: _this.editingRoleId
            }).then(function () {
        ...
        querycatalog(name, cb) {
            ...
            __WEBPACK_IMPORTED_MODULE_6_components_api_auth_apicatalog___default.a.fuzzyQuery(name).then(resp => {
                var result = [];
        ...
        querySelectUrl() {
            ...
            __WEBPACK_IMPORTED_MODULE_7_components_api_auth_apidoc___default.a.fuzzyQuery(para).then(resp => {
        ...
        addRoleUrl(item) {
            var _this = this;
            if (item && item.url) {
                var index = __WEBPACK_IMPORTED_MODULE_9_underscore___default.a.findLastIndex(_this.roleUrls, {
                    url: item.url
                });
                if (index == -1) {
                    _this.roleUrls.push({
        ...
        removeRoleUrl(url) {
            ...
            if (url) {
                ...
                if (index != -1) {
                    _this.roleUrls.splice(index, 1);
                }
            }
        },
        removeRoleUrlNode(index) {
            this.roleUrls.splice(index, 1);
        },
        selectUrl(items) {
        ...
        showAuth(row, index) {
            ...
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_3_components_api_auth_rolemenu_js___default.a.list(para).then(res => {
                var list = [];
                var menus = res.data;
                ...
                for (var i = 0; i < menus.length; i++) {
                    list.push(menus[i].menuId);
                }
                _this.authFormVisible = true;
                _this.default_menu_ids = list;
                console.log(list);
                setTimeout(function () {
                    _this.$refs.menuTree.setCheckedKeys(list);
                }, 100);
            });
            __WEBPACK_IMPORTED_MODULE_4_components_api_auth_roleurl_js___default.a.listRoleUrl(para).then(res => {
                // console.info(res);
                var roleurls = res.data;
                _this.roleUrls = roleurls;
                /*for (var i = 0; i < roleurls.length; i++) {
                    list.push(roleurls[i].urlId);
                }
                _this.authFormVisible = true;
                _this.default_url_ids = list;
                setTimeout(function () {
                    _this.$refs.urlTree.setCheckedKeys(list);
                }, 100)*/
            });
        },
        getUrls() {
            var para = {};
            __WEBPACK_IMPORTED_MODULE_7_components_api_auth_apidoc___default.a.list(para).then(resp => {
                this.urls = resp.data;
                for (var i = 0; i < this.urls.length; i++) {
                    this.urls[i].name = this.urls[i].catalog + ":" + this.urls[i].name;
                }
        ...
        getRoles() {
            ...
            var roleNameParam = this.filters.roleName;

            if (roleNameParam != '' & roleNameParam != "" & roleNameParam != "undefined" & roleNameParam != null) {
                para["roleName"] = roleNameParam;
            }
            ...
            __WEBPACK_IMPORTED_MODULE_1_components_api_role_js___default.a.getRoles(para).then(res => {
        ...
        handleDel: function (index, row) {
            this.$confirm('确认删除该记录吗?', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1_components_api_role_js___default.a.removeRole(para).then(res => {
                    this.listLoading = false;
                    __WEBPACK_IMPORTED_MODULE_0_nprogress___default.a.done();
                    this.$notify({
                        title: '成功',
        ...
        editSubmit: function () {
            this.$refs.editForm.validate(valid => {
                if (valid) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_components_api_role_js___default.a.editRole(para).then(res => {
        ...
        addSubmit: function () {
            this.$refs.addForm.validate(valid => {
                if (valid) {
                    ...
                    para['status'] = 1;
                    __WEBPACK_IMPORTED_MODULE_1_components_api_role_js___default.a.addRole(para).then(res => {
        ...
        batchRemove: function () {
            ...
            this.$confirm('确认删除选中记录吗？', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1_components_api_role_js___default.a.batchRemoveRole(para).then(res => {
                    this.listLoading = false;
                    __WEBPACK_IMPORTED_MODULE_0_nprogress___default.a.done();
                    this.$notify({
                        title: '成功',
    ...
    mounted() {
        this.getRoles();
        let _this = this;
        __WEBPACK_IMPORTED_MODULE_5_components_api_menu___default.a.listAll().then(function (resp) {
            var list = [];
            var menuList = resp.data;
            var map = {};
            _this.top.children = list;
            var ids = [];
            __WEBPACK_IMPORTED_MODULE_9_underscore___default.a.each(menuList, function (m) {
                _this.setNodeLabel(m);
                if (m.level == 1) {
                    list.push(m);
                    m.parent = _this.top;
                }
            ...
            _this.menulist = list;
            __WEBPACK_IMPORTED_MODULE_8_components_api_auth_menuurl___default.a.listbymenuids(ids).then(function (resp) {
                __WEBPACK_IMPORTED_MODULE_9_underscore___default.a.each(resp.data, function (d) {
                    _this.menuUrlMap[d.menuId] = d.urls;
                });
            });
        });
    }
...
var api = {
  list: function list(params) {
    return _axios2.default.post(base + '/rolemenu/list', params);
  },
  batchAdd: function batchAdd(list) {
    return _axios2.default.post(base + '/rolemenu/batchAdd', list);
  },
  batchDelete: function batchDelete(list) {
    return _axios2.default.post(base + '/rolemenu/batchDelete', list);
  }
};
...
var _babelPolyfill = __webpack_require__(164);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(scope) {
        ...
        }, [_vm._v("\r\n    编辑")]), _vm._v(" "), (_vm.authButtonVisible(scope.row.roleId)) ? _c('el-button', {
          attrs: {
            "size": "small"
          },
          on: {
        ...
        }, [_vm._v("授权")]) : _vm._e(), _vm._v(" "), (scope.row.status == 1) ? _c('el-button', {
          attrs: {
            "type": "danger",
            "size": "small"
          },
    ...
    ref: "menuAuthorizeForm",
    attrs: {
      "model": _vm.menuAuthorizeForm,
      "label-width": "80px"
    }
  }, [_c('div', {
    staticStyle: {
    ...
    on: {
      "check-change": _vm.menuCheckChange
    }
  ...
  }, [_c('ul', _vm._l((_vm.roleUrls), function(u, index) {
    return _c('li', [_vm._v(_vm._s(u.url) + "  "), _c('i', {
      staticClass: "el-icon-delete2",
      on: {
        "click": function($event) {
          _vm.removeRoleUrlNode(index)
        }
      }
    })])
  }))])])], 1)], 1), _vm._v(" "), _c('div', {
...
var update = __webpack_require__(187)("6c70d044", content, true);
