...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog__ = __webpack_require__(523);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_api_menu__ = __webpack_require__(808);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_api_menu___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_components_api_menu__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_underscore__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_underscore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_underscore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_common_filter__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_common_filter___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_components_common_filter__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        query() {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default.a.listpage({
        ...
        move(node, index, direction) {
            var _this = this;
            var list = _this.list;
            if ('up' == direction && index == 0) {
                this.$message.error('无法上移！');
                return;
            } else if ('down' == direction && index == _this.list.length - 1) {
                this.$message.error('无法下移！');
                return;
            }
            var offset = 'up' == direction ? -1 : 1;
            var other = list[index + offset];
            var sortNum = node.sortNum;
            node.sortNum = other.sortNum;
            other.sortNum = sortNum;
            __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default.a.switchOrder(node, other).then(respon => {
        ...
        moveUp(data, index) {
            this.move(data, index, 'up');
        },
        moveDown(data, index) {
            this.move(data, index, 'down');
        },
        add() {
        ...
        editNode(data, index) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.extendOwn(this.form, data);
        ...
        removeNode(data, index) {
            ...
            this.$confirm('确认删除分类?', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default.a.del(data.id).then(function (resp) {
                    _this.$notify.success({
                        message: "删除成功",
                        duration: 1000
                    });
        ...
        saveEditNode() {
            ...
            this.$refs.form.validate(function (valid) {
                ...
                var node = {};
                __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.extend(node, _this.form);
                if (node.id) {
                    __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default.a.update(node).then(function (resp) {
                        _this.$notify.success({
                            message: '保存成功',
                            duration: 1000
                        });
                        node.updateDate = Date.now();
                        __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.extend(_this.editingNode, node);
                        _this.dialogFormVisible = false;
                    });
                } else {
                    __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default.a.add(node).then(function (resp) {
                        _this.$notify.success({
                            message: '保存成功',
                            duration: 1000
                        });
        ...
        autoGenDoc(data) {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default.a.autoGenDoc(data.serviceId).then(function (resp) {
                _this.$notify.success({
                    message: '生成成功!',
                    duration: 1000
                });
        ...
        clearDoc(data) {
            var _this = this;
            this.$confirm('确认清除文档?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                __WEBPACK_IMPORTED_MODULE_0_components_api_auth_apicatalog___default.a.clearDoc(data.serviceId).then(function (resp) {
                    _this.$notify.success({
                        message: '清除成功!',
                        duration: 1000
                    });
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(scope) {
        return [_c('el-button', {
          ...
          on: {
            "click": function($event) {
              _vm.moveUp(scope.row, scope.$index)
            }
          }
          ...
          on: {
            "click": function($event) {
              _vm.moveDown(scope.row, scope.$index)
            }
          }
          ...
          on: {
            "click": function($event) {
              _vm.autoGenDoc(scope.row)
            }
          }
        }, [_vm._v("自动生成文档")]), _vm._v(" "), _c('el-button', {
          attrs: {
            "size": "small",
            "type": "danger"
          },
...
var update = __webpack_require__(187)("571fbd28", content, true);
