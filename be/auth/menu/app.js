...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_api_auth_menuurl__ = __webpack_require__(831);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_api_auth_menuurl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_components_api_auth_menuurl__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_api_auth_apicatalog__ = __webpack_require__(523);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_api_auth_apicatalog___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_components_api_auth_apicatalog__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_api_auth_apidoc__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_api_auth_apidoc___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_components_api_auth_apidoc__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_underscore__ = __webpack_require__(116);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data() {
        return {
            ...
            configUrlVisible: false,
            urlQueryVisible: false
        };
    },
    methods: {
        LTrim(str) {
        ...
        querycatalog(name, cb) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_components_api_auth_apicatalog___default.a.fuzzyQuery(name).then(resp => {
                var result = [];
                __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.each(resp.data, function (d) {
                    result.push({
                        value: d.name,
                        id: d.id
                    });
        ...
        querySelectUrl() {
            var _this = this;
            var para = {
                catalogId: _this.urlQueryForm.catalog ? _this.urlQueryForm.catalogId : "",
                url: _this.urlQueryForm.url
            };
            __WEBPACK_IMPORTED_MODULE_3_components_api_auth_apidoc___default.a.fuzzyQuery(para).then(resp => {
        ...
        addMenuUrl(item) {
            var _this = this;
            if (item && item.url) {
                var index = __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.findLastIndex(_this.urlForm.urls, {
                    url: item.url
                });
                if (index == -1) {
                    _this.urlForm.urls.push({
                        url: item.url,
                        id: item.id
                    });
                }
        ...
        removeRoleUrl(index) {
            this.urlForm.urls.splice(index, 1);
        },
        selectUrl(items) {
            this.urlQueryForm.urlSeleteItems = items;
        },
        addSelectUrl() {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.each(_this.urlQueryForm.urlSeleteItems, function (u) {
                _this.addMenuUrl(u);
            });
            _this.urlQueryVisible = false;
        },
        selectQueryCatalog(item) {
            this.urlQueryForm.catalogId = item.id;
        },
        selectQueryUrl(item, cb) {
            this.urlForm.urls.push({
                urlId: item.id,
                url: item.url
            });
        ...
        showSelectUrl() {
            ...
            this.urlQueryVisible = true;
            if (this.$refs.urlQueryForm) {
                this.$refs.urlQueryForm.resetFields();
            }
        },
        saveMenuUrl() {
            var _this = this;
            var fun = __WEBPACK_IMPORTED_MODULE_1_components_api_auth_menuurl___default.a.add;
            if (_this.urlForm.id) {
                fun = __WEBPACK_IMPORTED_MODULE_1_components_api_auth_menuurl___default.a.update;
            }
            fun(_this.urlForm).then(function () {
                _this.$notify.success({
                    message: '保存成功!',
                    duration: 1000
                });
                _this.$refs.urlForm.resetFields();
                _this.configUrlVisible = false;
            });
        },
        ...
        getCheckNode() {
            ...
            return checkNodes.length > 0 ? checkNodes[0] : null;
        },
        configUrl() {
            var node = this.getCheckNode();
            if (!node) {
            ...
            _this.urlForm.url = '';
            _this.urlForm.urls = [];
            __WEBPACK_IMPORTED_MODULE_1_components_api_auth_menuurl___default.a.getbymenuid(node.id).then(function (resp) {
                if (resp.data) {
                    __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.extend(_this.urlForm, resp.data);
                    if (!_this.urlForm.urls) {
                        _this.urlForm.urls = [];
                    }
                } else {
                    _this.urlForm.menuId = node.id;
                }
                _this.configUrlVisible = true;
            });
        },
        move(direction) {
            var _this = this;
            ...
            var list = [];
            if (node.level != 1) {
                __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.each(node.parent.children, function (n) {
                    list.push({
                        id: n.id,
                        number: n.number,
                        parentId: n.parentId,
            ...
            var index = __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.findIndex(list, {
                id: node.id
            });
            if ('up' == direction && index == 0) {
                this.$message.error('无法上移！');
                return;
            } else if ('down' == direction && index == list.length - 1) {
                this.$message.error('无法下移！');
                return;
            }
            var offset = 'up' == direction ? -1 : 1;
            var next = list[index + offset];
            var nodeNum = node.number;
            console.info(next.number);
            node.number = next.number;
            next.number = nodeNum;
            __WEBPACK_IMPORTED_MODULE_0_components_api_menu___default.a.switchIndex(node, next).then(respon => {
                this.$notify.success({
                    message: '移动成功！',
                    duration: 1000
                });
                if (node.level != 1) {
                    ...
                    list.splice(index, 1);
                    list.splice(index + offset, 0, node);
                }
                setTimeout(function () {
                    _this.$refs.tree.setCheckedNodes([node]);
                }, 50);
            });
        },
        moveUp() {
        ...
        addLevelOne() {
            var nodeNum = this.list.length > 0 ? parseInt(__WEBPACK_IMPORTED_MODULE_4_underscore___default.a.last(this.list).number) + 1 : 1;
            this.editingNode = {
                level: 1,
                parentId: null,
                number: nodeNum
        ...
        addChild() {
            ...
            var nodeNum = list.length > 0 ? parseInt(__WEBPACK_IMPORTED_MODULE_4_underscore___default.a.last(list).number) + 1 : 1;
            this.editingNode = {
                level: node.level + 1,
                parentId: node.id,
                number: nodeNum
        ...
        editNode() {
            ...
            this.editingNode = {};
            __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.extendOwn(this.editingNode, node);
            this.dialogFormVisible = true;
        },
        removeNode() {
            var _this = this;
            ...
            if (node.children && node.children.length > 0) {
                this.$message.error('有子节点数据无法删除！');
                return;
            }
            __WEBPACK_IMPORTED_MODULE_0_components_api_menu___default.a.del(node.id).then(function (resp) {
                _this.$notify.success({
                    message: '删除成功',
                    duration: 1000
                });
        ...
        saveEditNode() {
            ...
            var _this = this;
            var node = {};
            __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.extend(node, this.editingNode);
            if (this.editingNode.id) {
                ...
                if (!_this.Trim(node.url) && node.level == 3) {
                    _this.$notify.warning({
                        message: "节点url不能为空",
                        duration: 1000
                    });
                ...
                console.log(node);
                __WEBPACK_IMPORTED_MODULE_0_components_api_menu___default.a.update(node).then(function (resp) {
                    _this.$notify.success({
                        message: '保存成功',
                        duration: 1000
                    });
                    _this.setNodeLabel(_this.editingNode);
                    __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.extend(_this.getCheckNode(), _this.editingNode);
                });
            } else {
                //增加节点
                ...
                __WEBPACK_IMPORTED_MODULE_0_components_api_menu___default.a.add(node).then(function (resp) {
                    _this.$notify.success({
                        message: '新增节点成功',
                        duration: 1000
                    });
                    node = resp.data;
                    _this.setNodeLabel(node);
                    node.children = [];
                    if (node.level == 1) {
                        node.parent = _this.top;
                        _this.list.push(node);
                    } else {
                        node.parent = _this.getCheckNode();
                        _this.getCheckNode().children.push(node);
                    }
                });
            }
    ...
    mounted() {
        let _this = this;
        __WEBPACK_IMPORTED_MODULE_0_components_api_menu___default.a.listAll().then(function (resp) {
            var list = [];
            var menuList = resp.data;
            var map = {};
            _this.top.children = list;
            __WEBPACK_IMPORTED_MODULE_4_underscore___default.a.each(menuList, function (m) {
...
// module
exports.push([module.i, ".buttons{margin-top:20px}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "check-change": _vm.checkNode
    }
  })], 1), _vm._v(" "), _c('div', {
    staticClass: "buttons"
  }, [_c('el-button', {
    on: {
      "click": _vm.addLevelOne
    }
  }, [_vm._v("增加一级节点")]), _vm._v(" "), _c('el-button', {
    on: {
      "click": _vm.addChild
    }
  }, [_vm._v("增加子节点")]), _vm._v(" "), _c('el-button', {
    on: {
      "click": _vm.editNode
    }
  }, [_vm._v("编辑节点")]), _vm._v(" "), _c('el-button', {
    on: {
      "click": _vm.configUrl
    }
  }, [_vm._v("配置接口")]), _vm._v(" "), _c('el-button', {
    on: {
      "click": _vm.moveUp
    }
  ...
  }, [_vm._v("删除节点")])], 1), _vm._v(" "), _c('el-dialog', {
    attrs: {
      "title": "编辑节点"
    },
    model: {
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.$set(_vm.editingNode, "name", $$v)
      },
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.editingNode.level == 3),
      expression: "editingNode.level == 3"
    }],
    attrs: {
      "label": "节点url",
      "label-width": _vm.formLabelWidth
    ...
    model: {
      value: (_vm.editingNode.url),
      callback: function($$v) {
        _vm.$set(_vm.editingNode, "url", $$v)
      },
      expression: "editingNode.url"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    ...
    model: {
      value: (_vm.configUrlVisible),
      callback: function($$v) {
        _vm.configUrlVisible = $$v
      },
      expression: "configUrlVisible"
    }
  }, [_c('el-form', {
    ref: "urlForm",
    attrs: {
  ...
  }, [_vm._v("选择")])], 1)], 1), _vm._v(" "), _c('el-row', [_c('div', {
    staticStyle: {
      "height": "200px",
      "overflow": "scroll",
      "overflow-x": "hidden"
    }
  }, [_c('ul', _vm._l((_vm.urlForm.urls), function(u, index) {
    ...
    model: {
      value: (_vm.urlQueryVisible),
      callback: function($$v) {
        _vm.urlQueryVisible = $$v
      },
      expression: "urlQueryVisible"
    }
  }, [_c('el-form', {
    ref: "urlQueryForm",
    attrs: {
...
var update = __webpack_require__(187)("2f74397e", content, true);
