...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_api_tools_redis_js__ = __webpack_require__(972);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_api_tools_redis_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_components_api_tools_redis_js__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        query: function () {
            ...
            if (!key) {
                _this.$message.error('关键字不能为空');
                return;
            }
            console.info(key);
            __WEBPACK_IMPORTED_MODULE_0_components_api_tools_redis_js___default.a.queryKeys({
                key: key
            }).then(function (resp) {
        ...
        edit: function (key) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_components_api_tools_redis_js___default.a.get({
                key: key
            }).then(function (resp) {
        ...
        del: function (key, index) {
            var _this = this;
            __WEBPACK_IMPORTED_MODULE_0_components_api_tools_redis_js___default.a.del({
                key: key
            }).then(function (resp) {
        ...
        save: function () {
            ...
            _this.$refs.editForm.validate(function (valid) {
                ...
                __WEBPACK_IMPORTED_MODULE_0_components_api_tools_redis_js___default.a.save(_this.editForm).then(function (resp) {
                    _this.$notify.success("保存成功！");
                    if (!_this.isEdit) {
                        _this.list.unshift(_this.editForm.key);
                    }
...
var base = '/tools/redis';

var redis = {
	get: function get(data) {
		return _axios2.default.get(base + '/get', { params: data });
	},
	queryKeys: function queryKeys(data) {
		return _axios2.default.get(base + '/queryKeys', { params: data });
	},
	save: function save(data) {
		return _axios2.default.post(base + '/save', data);
	},
	del: function del(data) {
		return _axios2.default.get(base + '/del', { params: data });
	}
};
...
var _app = __webpack_require__(897);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("增加")])], 1)])], 1)], 1), _vm._v(" "), _c('el-row', [_c('el-col', {
    attrs: {
      "span": 18
    }
  }, [_c('el-table', {
...
var update = __webpack_require__(187)("407458cd", content, true);
